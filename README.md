...
An **AI web-based chat application** powered by **Next.js**, leveraging AI capabilities to provide interactive and responsive conversationss. Features a modern UI built with **Tailwind CSS** and **Shadcn UI** components, offering a seamless and engaging user experience.
